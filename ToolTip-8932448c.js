import { h as s, y, i } from './index-b37241ec.js';
...
class ToolTip extends s {
  constructor() {
    ...
    this.showing = false;
    this.tooltipContent = "";
    this.tooltipHTML = (content) => y`${content}`;
    this.mouseEL = (e) => {
  ...
  render() {
    return y`
      <div class="origin" ${n(this.origin)}></div>
      <div class="tooltip  ${this.showing ? "-show" : ""}" ${n(this.tooltip)}>
        ${this.tooltipContent}
      </div>
    `;
  }
...
export { ToolTip as T };
//# sourceMappingURL=ToolTip-8932448c.js.map
