...
var metadata$1 = {
	...
	{
		"stanza:key": "--togostanza-column-border_radius",
		"stanza:type": "number",
		"stanza:default": 0,
	...
	{
		"stanza:key": "--togostanza-node-padding_vertical",
		"stanza:type": "number",
		"stanza:default": 6,
		"stanza:description": "Vertical padding for nodes"
	},
	{
		"stanza:key": "--togostanza-node-padding_horizontal",
		"stanza:type": "number",
		"stanza:default": 6,
	...
	{
		"stanza:key": "--togostanza-node-selected_text_color",
		"stanza:type": "color",
	...
	{
		"stanza:key": "--togostanza-node-hover_text_color",
		"stanza:type": "color",
...
const typeArray = metadata$1["stanza:parameter"].map((param) => {
  return {
    name: lodashExports.camelCase(param["stanza:key"]),
...
class ColumnTree extends Stanza {
  ...
  async render() {
    ...
    Object.entries(this.params).forEach(([key, value]) => {
      camelCaseParams[lodashExports.camelCase(key)] = value;
    });
    ...
    this._app?.unmount();
    this._app = createApp(script, { ...camelCaseParams, main });
